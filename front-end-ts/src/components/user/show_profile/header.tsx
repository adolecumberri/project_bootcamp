...
class Header extends React.PureComponent<IProps> {
  ...
  render() {
    ...
    let bg = require("../../../images/ico_logo100x75.jpg");
    ...
    return (
      <div className="container-fluid px-0">
        {header ? (
          <div
            className="col-12 d-flex justify-content-center align-items-end aaa"
            id="header"
            style={{
          ...
          <div
            className="col-12 d-flex justify-content-center align-items-end bbb"
            id="header"
            style={{
